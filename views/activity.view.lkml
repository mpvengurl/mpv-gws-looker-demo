view: activity {
  sql_table_name: `bqexport.activity`
    ;;
  ...
  dimension: admin__document_id {
    type: string
    sql: ${TABLE}.admin.document_id ;;
    group_label: "Admin"
  ...
  dimension: admin__label_previous_principal_role {
    type: string
    sql: ${TABLE}.admin.label_previous_principal_role ;;
    group_label: "Admin"
    group_item_label: "Label Previous Principal Role"
  }
  ...
  dimension: admin__org_branding_editor_type {
    type: string
    sql: ${TABLE}.admin.org_branding_editor_type ;;
    group_label: "Admin"
    group_item_label: "Org Branding Editor Type"
  }

  dimension: admin__org_branding_provisioning_status {
    type: string
    sql: ${TABLE}.admin.org_branding_provisioning_status ;;
    group_label: "Admin"
    group_item_label: "Org Branding Provisioning Status"
  }

  dimension: admin__org_branding_upload_status {
    type: string
    sql: ${TABLE}.admin.org_branding_upload_status ;;
    group_label: "Admin"
    group_item_label: "Org Branding Upload Status"
  }
  ...
  dimension: admin__shared_drive_name {
    type: string
    sql: ${TABLE}.admin.shared_drive_name ;;
    group_label: "Admin"
    group_item_label: "Shared Drive Name"
  }
  ...
  dimension: admin__user_display_name {
    type: string
    sql: ${TABLE}.admin.user_display_name ;;
    group_label: "Admin"
  ...
  dimension: calendar__appointment_schedule_title {
    type: string
    sql: ${TABLE}.calendar.appointment_schedule_title ;;
    group_label: "Calendar"
    group_item_label: "Appointment Schedule Title"
  }
  ...
  dimension: calendar__client_side_encrypted {
    type: string
    sql: ${TABLE}.calendar.client_side_encrypted ;;
    group_label: "Calendar"
    group_item_label: "Client Side Encrypted"
  }
  ...
  dimension: calendar__is_recurring {
    type: yesno
    sql: ${TABLE}.calendar.is_recurring ;;
    group_label: "Calendar"
    group_item_label: "Is Recurring"
  }
  ...
  dimension: calendar__recurring {
    type: string
    sql: ${TABLE}.calendar.recurring ;;
    group_label: "Calendar"
    group_item_label: "Recurring"
  }
  ...
  dimension: chat__actor_type {
    type: string
    sql: ${TABLE}.chat.actor_type ;;
    group_label: "Chat"
    group_item_label: "Actor Type"
  }
  ...
  dimension: chat__report_id {
    type: string
    sql: ${TABLE}.chat.report_id ;;
    group_label: "Chat"
  ...
  dimension: chrome__is_federated {
    ...
    group_label: "Chrome"
    group_item_label: "Is Federated"
  }

  dimension: chrome__localized_url_category {
    type: string
    sql: ${TABLE}.chrome.localized_url_category ;;
    group_label: "Chrome"
    group_item_label: "Localized URL Category"
  }
  ...
  dimension: chrome__unlock_type {
    type: string
    sql: ${TABLE}.chrome.unlock_type ;;
    group_label: "Chrome"
    group_item_label: "Unlock Type"
  }
  ...
  dimension: drive__recipients {
    hidden: yes
    sql: ${TABLE}.drive.recipients ;;
    group_label: "Drive"
  ...
  dimension: drive__requested_role {
    type: string
    sql: ${TABLE}.drive.requested_role ;;
    group_label: "Drive"
    group_item_label: "Requested Role"
  }

  dimension: drive__revision_create_timestamp {
    type: number
    sql: ${TABLE}.drive.revision_create_timestamp ;;
    group_label: "Drive"
    group_item_label: "Revision Create Timestamp"
  }

  dimension: drive__revision_id {
    type: string
    sql: ${TABLE}.drive.revision_id ;;
    group_label: "Drive"
    group_item_label: "Revision ID"
  }

  dimension: drive__script_container_app {
    type: string
    sql: ${TABLE}.drive.script_container_app ;;
    group_label: "Drive"
    group_item_label: "Script Container App"
  }

  dimension: drive__script_container_id {
    type: string
    sql: ${TABLE}.drive.script_container_id ;;
    group_label: "Drive"
    group_item_label: "Script Container ID"
  }

  dimension: drive__script_trigger_id {
    type: string
    sql: ${TABLE}.drive.script_trigger_id ;;
    group_label: "Drive"
    group_item_label: "Script Trigger ID"
  }

  dimension: drive__script_trigger_source_app {
    type: string
    sql: ${TABLE}.drive.script_trigger_source_app ;;
    group_label: "Drive"
    group_item_label: "Script Trigger Source App"
  }

  dimension: drive__script_trigger_type {
    type: string
    sql: ${TABLE}.drive.script_trigger_type ;;
    group_label: "Drive"
    group_item_label: "Script Trigger Type"
  }
  ...
  dimension: drive__track_name {
    type: string
    sql: ${TABLE}.drive.track_name ;;
    group_label: "Drive"
    group_item_label: "Track Name"
  }
  ...
  dimension: gmail__message_info__action_type {
    ...
    group_label: "Gmail Message Info"
    group_item_label: "Action Type"
  }
  ...
  dimension: gmail__message_info__connection_info__authenticated_domain {
    ...
    group_label: "Gmail Message Info Connection Info"
  ...
  dimension: gmail__message_info__connection_info__is_intra_domain {
    ...
    group_label: "Gmail Message Info Connection Info"
    group_item_label: "Is Intra Domain"
  }
  ...
  dimension: gmail__message_info__flattened_destinations {
    ...
    group_label: "Gmail Message Info"
    group_item_label: "Flattened Destinations"
  }
  ...
  dimension: gmail__message_info__is_policy_check_for_sender {
    ...
    group_label: "Gmail Message Info"
    group_item_label: "Is Policy Check for Sender"
  }
  ...
  dimension: gmail__message_info__rfc2822_message_id {
    ...
    group_label: "Gmail Message Info"
    group_item_label: "Rfc2822 Message ID"
  }
  ...
  dimension: gmail__message_info__smime_content_type {
    ...
    group_label: "Gmail Message Info"
    group_item_label: "Smime Content Type"
  }
  ...
  dimension: gmail__message_info__smime_encrypt_message {
    ...
    group_label: "Gmail Message Info"
    group_item_label: "Smime Encrypt Message"
  }
  ...
  dimension: gmail__message_info__smime_extraction_success {
    ...
    group_label: "Gmail Message Info"
    group_item_label: "Smime Extraction Success"
  }
  ...
  dimension: gmail__message_info__smime_packaging_success {
    ...
    group_label: "Gmail Message Info"
    group_item_label: "Smime Packaging Success"
  }
  ...
  dimension: gmail__message_info__smime_sign_message {
    ...
    group_label: "Gmail Message Info"
    group_item_label: "Smime Sign Message"
  }
  ...
  dimension: gmail__message_info__source__address {
    ...
    group_label: "Gmail Message Info Source"
  ...
  dimension: gmail__message_info__spam_info__classification_reason {
    ...
    group_label: "Gmail Message Info Spam Info"
  ...
  dimension: gmail__message_info__structured_policy_log_info__detected_file_types {
    ...
    group_label: "Gmail Message Info Structured Policy Log Info"
  ...
  dimension: gmail__message_info__structured_policy_log_info__exchange_journal_info__recipients {
    ...
    group_label: "Gmail Message Info Structured Policy Log Info Exchange Journal Info"
    group_item_label: "Recipients"
  }
  ...
  dimension: login__is_second_factor {
    ...
    group_label: "Login"
    group_item_label: "Is Second Factor"
  }
  ...
  dimension: login__is_suspicious {
    ...
    group_label: "Login"
    group_item_label: "Is Suspicious"
  }
  ...
  dimension: meet__action_time {
    type: string
    sql: ${TABLE}.meet.action_time ;;
    group_label: "Meet"
    group_item_label: "Action Time"
  }
  ...
  dimension: meet__streaming_session_state {
    type: string
    sql: ${TABLE}.meet.streaming_session_state ;;
    group_label: "Meet"
    group_item_label: "Streaming Session State"
  }
  ...
  dimension: meet__target_user_count {
    type: number
    sql: ${TABLE}.meet.target_user_count ;;
    group_label: "Meet"
    group_item_label: "Target User Count"
  }
  ...
  dimension: rules__snippets {
    hidden: yes
    sql: ${TABLE}.rules.snippets ;;
    group_label: "Rules"
    group_item_label: "Snippets"
  }
  ...
  dimension: voice__param_network_statistics_str {
    type: string
    sql: ${TABLE}.voice.param_network_statistics_str ;;
    group_label: "Voice"
    group_item_label: "Param Network Statistics Str"
  }
  ...
  set: detail {
    fields: [
      ...
      chrome__device_name,
      mobile__policy_name,
      admin__customer_name,
      admin__user_nickname,
      admin__sync_job_name,
      admin__org_unit_name,
      rules__resource_name,
      chrome__content_name,
      chrome__product_name,
      drive__category_name,
      admin__framework_name,
      admin__privilege_name,
      chrome__org_unit_name,
      chat__attachment_name,
      admin__api_client_name,
      admin__oauth2_app_name,
      admin__quarantine_name,
      saml__application_name,
      admin__application_name,
      admin__addressbook_name,
      admin__certificate_name,
      data_studio__asset_name,
      gplus__post_author_name,
      chrome__login_user_name,
      admin__dlp_detector_name,
      admin__user_display_name,
      admin__access_level_name,
      admin__shared_drive_name,
      admin__print_server_name,
      admin__investigation_name,
      rules__rule_resource_name,
      gplus__post_resource_name,
      chrome__profile_user_name,
      admin__scim_directory_name,
      admin__oauth2_service_name,
      voice__param_ring_group_name,
      admin__ldap_certificate_name,
      admin__permission_group_name,
      admin__secondary_domain_name,
      admin__ldap_application_name,
      admin__remote_directory_name,
      login__sensitive_action_name,
      gplus__comment_resource_name,
      voice__param_meet_device_name,
      voice__param_pbx_service_name,
      admin__previous_customer_name,
      admin__custom_user_field_name,
      admin__custom_user_schema_name,
      admin__connector_provider_name,
      gplus__log_event_resource_name,
      admin__distribution_entity_name,
      admin__system_defined_rule_name,
      admin__inbound_sso_profile_name,
      voice__param_auto_attendant_name,
      voice__usage_billing_entity_name,
      admin__ldap_credentials_username,
      admin__investigation_action_name,
      admin__user_defined_setting_name,
      admin__security_center_rule_name,
      admin__managed_configuration_name,
      admin__investigation_setting_name,
      admin__saml2_service_provider_name,
      admin__chrome_browser_machine_name,
      admin__mobile_wireless_network_name,
      admin__connector_configuration_name,
      admin__source_directory_display_name,
      admin__play_for_work_mdm_vendor_name,
      admin__investigation_data_source_name,
      admin__mobile_certificate_common_name,
      admin__saml2_service_provider_attribute_name,
      admin__auto_prov_service_provider_attribute_name,
      gmail__message_info__source__from_header_displayname,
      admin__investigation_download_attachment_attachment_name
    ]
  }
}
...
view: activity__drive__recipients {
  dimension: activity__drive__recipients {
    type: string
    sql: activity__drive__recipients ;;
  }
}
...
view: activity__rules__snippets {
  dimension: detector_id {
    type: string
    sql: ${TABLE}.detector_id ;;
  }

  dimension: match_length {
    type: number
    sql: ${TABLE}.match_length ;;
  }
